...
- Name: keyboard.spec.ts >> Keyboard accessibility >> Tab order reaches the persistent Register CTA before entering
- Location: e2e/keyboard.spec.ts:42:7

# Error details

```
Error: Tab should be able to focus .xp-cta (persistent Register CTA) before entering
