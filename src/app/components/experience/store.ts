 ...
 */
const JUMP_IN = 0.149; // "3" — streaks begin stretching
const JUMP_FULL = 0.271; // past "1", fully in hyperspace
const JUMP_HOLD = 0.469; // last track card
const JUMP_OUT = 0.51; // back out, the wire world returns
